...
<svg width="90" height="90" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    <circle cx="50" cy="50" r="46" fill="none" stroke="#C5A028" stroke-width="1.5"/>
    <circle cx="50" cy="50" r="40" fill="none" stroke="#C5A028" stroke-width="1"/>
    <circle cx="50" cy="50" r="37" fill="none" stroke="#C5A028" stroke-width="0.6"/>
    <g stroke="#C5A028" stroke-width="1">
        ...
        <line x1="18" y1="82" x2="22" y2="78"/>
        <line x1="78" y1="22" x2="82" y2="18"/>
    </g>
    <text x="50" y="62" font-family="'Playfair Display', serif" font-size="34"
          font-weight="600" fill="#C5A028" text-anchor="middle"
          letter-spacing="1">SH</text>
</svg>
"""
